...
{
    public class DataAbiDeployment : DataAbiDeploymentBase
    {
        public DataAbiDeployment() : base(Bytecode)
        {
        }

        public DataAbiDeployment(string byteCode) : base(byteCode)
        {
        }
    }

    public class DataAbiDeploymentBase : ContractDeploymentMessage
    {
        ...
        public DataAbiDeploymentBase() : base(Bytecode)
        {
        }

        public DataAbiDeploymentBase(string byteCode) : base(byteCode)
        {
        }

        [Parameter("address", "addressesProvider")]
        public virtual string AddressesProvider { get; set; }
    }
}